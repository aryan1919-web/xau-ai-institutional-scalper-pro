...
- **Current version:** `0.2.3` — Module 03 (Momentum Engine) in progress (M3.3: multi-timeframe confirmation).
...
| `0.2.3` | M3.3 — Momentum: multi-timeframe confirmation | MTF via `ctxHtfValue`, alignment, confidence, quality, trend confirmation. **(current)** |
